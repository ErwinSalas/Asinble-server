...
inventory = InventoryManager(loader=loader, sources='/home/erwin-salas/Documentos/GitHub/Asinble-server/Inventory/inventory_test')
...
options = Options(listtags=False, listtasks=False, listhosts=False, syntax=False,
                  ...
                  private_key_file='adminlabicssc2018', ssh_common_args=None, ssh_extra_args=None, sftp_extra_args=None,
                  scp_extra_args=None, become=True, become_method='sudo',
                  become_user='root', verbosity=None, check=False, diff=False)

variable_manager.extra_vars = {'hosts': 'all'} # This can accomodate various other command line arguments.`
